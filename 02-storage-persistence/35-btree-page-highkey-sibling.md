...
源码基线：本课基于本地 `/home/highgo/postgres` 源码，分支 `master`，提交 `bd4bd30ce6a7f08e95390c3fa068f2bfbe9fcee8`（commit date: 2026-06-09）。行号来自 `git -C /home/highgo/postgres show bd4bd30ce6a7f08e95390c3fa068f2bfbe9fcee8:<file> | nl -ba`；重点源码和辅助观察入口统一放在第 3 节的阅读顺序里。
